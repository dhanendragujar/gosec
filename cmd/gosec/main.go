...
var (
	...
	// format output
	flagFormat = flag.String("fmt", "json", "Set output format. Valid options are: json, yaml, csv, junit-xml, html, or text")
...
/*
	...
	collection_type := "SAST"
	fmt.Fprintf(os.Stdout, "collection_type: " + collection_type + "\n")
